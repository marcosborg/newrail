    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_pt') ? 'is-invalid' : '' }}" type="text" name="name_pt" id="name_pt" value="{{ old('name_pt', $product->name_pt) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_pt') ? 'is-invalid' : '' }}" name="description_pt" id="description_pt">{!! old('description_pt', $product->description_pt) !!}</textarea>
