    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.categories.update", [$category->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_pt') ? 'is-invalid' : '' }}" type="text" name="name_pt" id="name_pt" value="{{ old('name_pt', $category->name_pt) }}" required>
                @if($errors->has('name_pt'))
                    <span class="text-danger">{{ $errors->first('name_pt') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_pt') ? 'is-invalid' : '' }}" name="description_pt" id="description_pt">{!! old('description_pt', $category->description_pt) !!}</textarea>
                @if($errors->has('description_pt'))
                    <span class="text-danger">{{ $errors->first('description_pt') }}</span>
                @endif
