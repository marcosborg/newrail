    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('train_type_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.train-types.index") }}" class="nav-link {{ request()->is("admin/train-types") || request()->is("admin/train-types/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-train">

                            </i>
                            <p>
                                {{ trans('cruds.trainType.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
                @can('train_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.trains.index") }}" class="nav-link {{ request()->is("admin/trains") || request()->is("admin/trains/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-train">
                ...
                @can('carriage_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.carriages.index") }}" class="nav-link {{ request()->is("admin/carriages") || request()->is("admin/carriages/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-train">

                            </i>
                            <p>
                                {{ trans('cruds.carriage.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
